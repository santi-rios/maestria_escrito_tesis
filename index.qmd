...
Al menos en roedores, esta neurogénsis hipocampal involucra la presencia de células madres neurales a lo largo de la vida del roedor. Estas células madre neurales (NSCs) generan nuevas neuronas a lo largo de la vida en el cerebro estos animales. Las neuronas nacidas en la adultez moldean la función cerebral y la dinámica del hipocampo, por lo que el estudio de la dinámica de la NHA es un factor importante a considerar en las funciones cognitivas [@denoth-lippuner2021]. 
...
nado_frozado_segmentos_df |>
  ...
  ggpubr::ggline(
    ...
    add = "mean_se",
    numeric.x.axis = TRUE,
    xlab = "Segmento de la Prueba (segundos)",
